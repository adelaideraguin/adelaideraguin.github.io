            ...
            <Card sx={{marginTop: "1em",  position:"relative", color: "white", paddingLeft: "1em",
              paddingRight: "1em"}}>
                   <Typography paddingLeft="0.25em" paddingRight="0.25em"  align='left' paddingLeft="2em" paddingRight="2em" variant="h5" sx={{ marginTop: "2em", marginBottom: "2em", color: "black", display: { xs: "none", sm: "none", md: "block" } }}>
                        <p>We develop computational and mathematical methods to study the dynamics of complex biological systems at the sub-cellular scale. Our main expertise are stochastic simulations that we use to investigate the synthesis or degradation of large polymeric systems, and collective transport processes in one dimension. Some of the scientific questions we investigate are: </p>
